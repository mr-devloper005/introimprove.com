export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'introimprove',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Introimprove',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'introimprove.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://introimprove.com',
