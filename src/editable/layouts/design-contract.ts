...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#16325c',
  '--slot4-panel-bg': '#d8e8fb',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#66758c',
  '--slot4-soft-muted-text': '#8b9bb1',
  '--slot4-accent': '#2f6fcc',
  '--slot4-accent-fill': '#417dcc',
  '--slot4-accent-soft': '#fdecec',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#1d2f4a',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dceaf8',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f2f7fd',
  '--slot4-lavender': '#eaf4ff',
  '--slot4-gray': '#f6f8fb',
  '--slot4-body-gradient': 'linear-gradient(180deg,#ffffff 0%,#f8fbff 48%,#ffffff 100%)',
  '--editable-page-bg': '#ffffff',
  '--editable-page-text': '#16325c',
  '--editable-container': '1120px',
  '--editable-border': '#d8e0ea',
  '--editable-nav-bg': '#1b2935',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#417dcc',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#2f6fcc',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#457fca',
